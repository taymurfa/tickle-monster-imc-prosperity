...
def hp_orders(state: Dict[str, Any], trading_state: TradingState) -> List[Order]:
    ...
    if buy_edge > buy_threshold and position < 0.70 * POSITION_LIMITS[HP]:
        ...
        reason = f"HP_BUY_predicted_reversion_move={prediction['predicted_move']:.2f}"
        ...
        reason = f"HP_SELL_predicted_reversion_move={prediction['predicted_move']:.2f}"
        ...
        reason = f"HP_NO_TRADE_predicted_reversion_move={prediction['predicted_move']:.2f}"
