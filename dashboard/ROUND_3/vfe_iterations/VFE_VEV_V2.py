...
VOUCHER_AGG_IMB_THRESHOLD = 0.25      # V2: 0.5 -> 0.25 (sweep showed +60 PnL plateau at 0.10..0.30)
VOUCHER_SOFT_CAP = 100                # per-voucher position soft cap (limit is 300)
VOUCHER_SKEW_COEFF = 0.015            # V2: 0.05 -> 0.015 (best Sharpe in sweep, +1131 PnL, 3/3 days up)
