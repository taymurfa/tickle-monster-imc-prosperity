...
class Trader:
    def bid(self) -> int:
        ...
        # Strategy: bid non-round number just above expected competitor round-number clusters
        # (500, 1000, 1500). 1,001 beats anyone bidding exactly 1,000 while spending only 56%
        # of EV — positive expected value of ~+800 XIRECs per day won.
        # Calibrate higher (e.g. 1,201 or 1,501) after reviewing R1 leaderboard distribution.
        return 1001
